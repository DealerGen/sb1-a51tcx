...
const Statistics: React.FC = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-indigo-900 to-purple-800 p-6 rounded-lg shadow-lg mb-8 text-white">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        <div className="bg-white bg-opacity-10 p-4 rounded-lg">
          ...
          <p className="text-sm text-gray-300">Qualified: {qualifiedCars}</p>
        </div>
        <div className="bg-white bg-opacity-10 p-4 rounded-lg">
        ...
        <div className="bg-white bg-opacity-10 p-4 rounded-lg">
          ...
          <p className="text-sm text-gray-300">Won: {wonCars} / Bid: {bidCars}</p>
        </div>
        <div className="bg-white bg-opacity-10 p-4 rounded-lg">
          <h3 className="text-lg font-semibold mb-2 flex items-center">
